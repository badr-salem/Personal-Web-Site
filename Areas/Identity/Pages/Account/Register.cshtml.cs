...
namespace BadrBinHomeed_NEW.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //check if the admin role doesnt exits so create it
                    //if (!await _roleManager.RoleExistsAsync(SD.Role_Admin))
                    //{
                    //    await _roleManager.CreateAsync(new IdentityRole(SD.Role_Admin));
                    //}
                    //check if the Indi role doesnt exits so create it
                    ...
                    //its make anyone register become admin we do that at first login the delete it
